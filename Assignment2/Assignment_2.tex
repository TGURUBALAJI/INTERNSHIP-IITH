...
\begin{align}
\myvec{k-3 & -(4-k^2)}\vec{x}+k^2-7k+6=0\label{eq:1}\end{align}
...
\item Parallel to y-axis\\
 \begin{align}\vec{n} & =\myvec{1 & 0} \end{align} if the line is parallel to y-axis\\
Equation of y-axis is  \begin{align}\begin{split}\myvec{0 & 1}\vec{x} & =0\\
\myvec{0 & 1}\myvec{k-3\\-(4-k^2)} & = 0\\ \label{eq1}
 4-k^2 & =0\\
 \implies k & =\pm2
\end{split}
\end{align}
